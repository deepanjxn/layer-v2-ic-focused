                ...
                <div>
                    ...
                    <div aria-hidden className="relative">
                        <div className="absolute inset-0 z-10 m-auto size-fit">
                            <div className="bg-background relative flex size-fit w-fit items-center gap-2 rounded-lg border px-3 py-1 text-xs font-medium shadow-md shadow-black/5">
                                <span className="text-lg">🇨🇩</span> Last connection from DR Congo
                            </div>
                            <div className="bg-background absolute inset-2 -bottom-2 mx-auto rounded-lg border px-3 py-4 text-xs font-medium shadow-md shadow-black/5"></div>
                        </div>

                        <div className="relative overflow-hidden">
                            <div className="z-1 to-background absolute inset-0 [background-image:radial-gradient(var(--tw-gradient-stops))] from-transparent to-75%"></div>
                            <Map />
                        </div>
                    </div>
                </div>
                ...
                <div className="overflow-hidden border-t bg-gray-50 p-6 sm:p-12 md:border-0 md:border-l">
                    ...
                    <div aria-hidden className="flex flex-col gap-8">
                        <div>
                            ...
                            <div className="bg-background mt-1.5 w-3/5 rounded-lg border p-3 text-xs">Hey, I&apos;m having trouble with my account.</div>
                        </div>

                        <div>
                            <div className="mb-1 ml-auto w-3/5 rounded-lg bg-blue-600 p-3 text-xs text-white">Molestiae numquam debitis et ullam distinctio provident nobis repudiandae deleniti necessitatibus.</div>
